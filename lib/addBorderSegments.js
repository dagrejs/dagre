...
function addBorderSegments(g) {
  ...
  g.eachNode(function(u, value) {
    ...
    if (children.length) {
      ...
      for (i = min; i <= max; ++i) {
        leftSeg = g.addNode(leftIdGen(), { rank: i, width: 0, height: 0, leftBorderSegment: true, dummy: true });
        rightSeg = g.addNode(rightIdGen(), { rank: i, width: 0, height: 0, rightBorderSegment: true, dummy: true });
