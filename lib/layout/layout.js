...
module.exports = function() {
   ...
   */
  function buildAdjacencyGraph(inputGraph, constraintGraph) {
    var g = new CDigraph();
    ...
    if (constraintGraph) {
      g.graph().constraintGraph = constraintGraph;
    }

    return g;
  }

  function run(inputGraph, constraintGraph) {
    var rankSep = self.rankSep();
    var g;
    try {
      // Build internal graph
      g = buildAdjacencyGraph(inputGraph, constraintGraph);
