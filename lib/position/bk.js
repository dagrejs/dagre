...
function horizontalCompaction(g, layering, root, align, reverseSep) {
  ...
  // This function handles iterating over the graph without using recursion. The
  // argument, helper, returns an array of functions. These returned functions
  // are the recursive and base function calls. The recursive case might
  // generate additional functions that will be prepended to the array of calls.
  function iterate(helper, v) {
    if (!_.has(visited, v)) {
      visited[v] = true;
  ...
  // will be called by iterate. At the end of those functions, there is another
  ...
  // another function that will set xs[v] with the greatest coordinates.
  function pass2(v) {
