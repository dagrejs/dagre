...
function rank(g, useSimplex) {
  ...
  var constrainedGraph = util.time(constrainRanks)(g.filterNodes(util.filterNonSubgraphs(g)));

  // Reverse edges to get an acyclic graph, we keep the graph in an acyclic
  // state until the very end.
  util.time(acyclic)(constrainedGraph);
  ...
  util.time(applyConstrainedGraph)(constrainedGraph, g);
