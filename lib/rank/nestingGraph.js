...
function augment(g) {
  ...
  function dfs(u) {
    ...
    if (children.length) {
      ...
      if (u !== null) {
        var top = g.addNode(topIdGen(), { width: 0, height: 0, nestingGraphTop: true }),
            bottom = g.addNode(bottomIdGen(), { width: 0, height: 0, nestingGraphBottom: true }),
            value = g.node(u),
        ...
        children.forEach(function(v) {
          ...
          g.addEdge(topIdGen(), top, v, { minLen: minLen, nestingEdge: true });
          g.addEdge(bottomIdGen(), v, bottom, { minLen: minLen, nestingEdge: true });
        });
      }
    }
  }
