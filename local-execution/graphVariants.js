...
export const variant1to2 = {
  nodes: [
    ...
    { id: "End", width: 40, height: 30, label: "End" },
    { id: "zugehöriger Wareneingang", width: 160, height: 25, label: "zugehöriger Wareneingang" },
  ...
  edges: [
    ...
    { source: "Start", target: "Auftragserstellung", weight: 1, id: "t-start-auftragserstellung" },
    { source: "Zahlungseingang", target: "End", weight: 1, id: "t-zahlungseingang-end" },
    { source: "Auftragserstellung", target: "zugehöriger Wareneingang", weight: 1, id: "t-auftragserstellung-zugehoeriger_wareneingang" },
    { source: "zugehöriger Wareneingang", target: "VK-Lieferung", weight: 1, id: "t-zugehoeriger_wareneingang-vk-lieferung" },
...
export const variant1to3 = {
  nodes: [
    ...
    { id: "Durchführung der Reise", width: 160, height: 25, label: "Durchführung der Reise" },
  ...
  edges: [
    ...
    { source: "Durchführung der Reise", target: "Reisekostenerfassung", weight: 1, id: "t-durchfuehrung_der_reise-reisekostenerfassung" },
    { source: "Reisekostenfreigabe 2", target: "Durchführung der Reise", weight: 1, id: "t-reisekostenfreigabe_2-durchfuehrung_der_reise" },
...
export const variant1to4 = {
  ...
  edges: [
    ...
    { source: "zugehöriger Wareneingang", target: "Zahlungseingang", weight: 1, id: "t-zugehoeriger_wareneingang-zahlungseingang" },
    { source: "Anlage der Bestellung", target: "zugehöriger Wareneingang", weight: 1, id: "t-anlage_der_bestellung-zugehoeriger_wareneingang" }
  ]
};
...
export const variant1to7 = {
  ...
  edges : [
    ...
    { source: "Auftragserstellung", target: "zugehöriger Wareneingang", weight: 1 },
    { source: "zugehöriger Wareneingang", target: "VK-Lieferung", weight: 1 },
    ...
    { source: "Durchführung der Reise", target: "Reisekostenerfassung", weight: 1 },
    { source: "Reisekostenfreigabe 2", target: "Durchführung der Reise", weight: 1 },
    ...
    { source: "zugehöriger Wareneingang", target: "Zahlungseingang", weight: 1 },
    { source: "Anlage der Bestellung", target: "zugehöriger Wareneingang", weight: 1 },
    { source: "VK-Lieferung", target: "zugehöriger Wareneingang", weight: 1 },
    { source: "zugehöriger Wareneingang", target: "Anlage der Bestellung", weight: 1 },
    { source: "zugehöriger Wareneingang", target: "VK-Rechnung", weight: 1 },
    { source: "zugehöriger Wareneingang", target: "Auftragserstellung", weight: 1 }
  ],
};
